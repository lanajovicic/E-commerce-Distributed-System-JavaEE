...
CREATE TABLE `transakcija` (
  ...
  PRIMARY KEY (`IdTrans`),
  KEY `fk_IdNar` (`IdNar`),
  CONSTRAINT `fk_IdNar` FOREIGN KEY (`IdNar`) REFERENCES `narudzbina` (`IdNar`) ON UPDATE CASCADE
...
INSERT INTO `transakcija` VALUES (1,4,2749.98,'2026-03-14 03:32:30'),(2,5,2749.98,'2026-03-14 03:33:49'),(3,6,2559.98,'2026-03-14 09:39:40'),(4,7,1199.98,'2026-03-14 09:50:07'),(5,8,6959.95,'2026-03-14 09:56:13');
